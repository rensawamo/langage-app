...
class AppEnBeginnerQuizData {
  ...
  static final List<Quiz> englishBiginnerAdjectives = [
    ...
    Quiz(
      text: "bad-tasting",
      sentence: "This food tastes bad.",
      translation: "この料理はまずい。",
      pronunciation: "bæd-teɪstɪŋ, バッドテイスティング",
      options: [
    ...
    Quiz(
      ...
      pronunciation: "ɪkˈspɛnsɪv, エクスペンシブ",
      options: [
        Option(text: "高い", isCorrect: true),
        Option(text: "安い", isCorrect: false),
    ...
    Quiz(
      ...
      translation: "彼女と私は違う。",
      pronunciation: "ˈdɪfərənt, ディファレント",
      options: [
    ...
    Quiz(
      ...
      pronunciation: "kənˈvinjənt, コンビニエント",
      options: [
    ...
    Quiz(
      text: "bland",
      sentence: "The soup is bland.",
      translation: "このスープは薄い。",
      pronunciation: "blænd, ブランド",
      options: [
    ...
    Quiz(
      ...
      pronunciation: "rɪˈɡrɛtfəl, リグレットフル",
      options: [
    ...
    Quiz(
      text: "painful",
      sentence: "My shoulder is painful.",
      translation: "肩が痛い。",
      pronunciation: "ˈpeɪnfəl, ペインフル",
      options: [
        Option(text: "羨ましい", isCorrect: false),
    ...
    Quiz(
      text: "homesick",
      sentence: "I am homesick for my hometown.",
      translation: "故郷が恋しい。",
      pronunciation: "ˈhoʊmsɪk, ホームシック",
      options: [
    ...
    Quiz(
      text: "embarrassed",
      sentence: "I am embarrassed by that mistake.",
      translation: "そのミスが恥ずかしい。",
      pronunciation: "ɪmˈbærəst, エンバラスト",
      options: [
        Option(text: "羨ましい", isCorrect: false),
        Option(text: "厳しい", isCorrect: false),
        Option(text: "憎い", isCorrect: false),
    ...
    Quiz(
      ...
      pronunciation: "ˈbjutɪfəl, ビューティフル",
      options: [
  ...
  static final List<Quiz> englishBiginnerAdvers = [
    ...
    Quiz(
      ...
      pronunciation: "ɪkˈstriːmli, エクストリームリー",
      options: [
    ...
    Quiz(
      ...
      pronunciation: "ˈfriːkwəntli, フリークウェントリー",
      options: [
    ...
    Quiz(
      ...
      pronunciation: "ˈɔlmoʊst, オールモースト",
      options: [
    ...
    Quiz(
      ...
      pronunciation: "kəmˈpliːtli, コンプリートリー",
      options: [
        Option(text: "少し", isCorrect: false),
    ...
    Quiz(
      ...
      pronunciation: "ˈdʒɛnərəli, ジェネラリー",
      options: [
        Option(text: "全然", isCorrect: false),
        Option(text: "頻繁に", isCorrect: false),
    ...
    Quiz(
      ...
      pronunciation: "ˈjuːʒuəli, ユージュアリー",
      options: [
        Option(text: "全然", isCorrect: false),
        Option(text: "たまに", isCorrect: false),
        Option(text: "時々", isCorrect: false),
    ...
    Quiz(
      text: "usually",
      sentence: "I usually exercise in the morning.",
    ...
    Quiz(
      ...
      pronunciation: "ɪˈspɛʃəli, エスペシャリー",
      options: [
    ...
    Quiz(
      ...
      pronunciation: "ˈsʌmtaɪmz, サムタイムズ",
      options: [
        Option(text: "いつも", isCorrect: false),
        Option(text: "特に", isCorrect: false),
    ...
    Quiz(
      text: "recklessly",
      sentence: "Don't act recklessly.",
      translation: "分別なく行動しないでください。",
      pronunciation: "ˈrɛklɪsli, レックレスリー",
      options: [
        Option(text: "しっかり", isCorrect: false),
        Option(text: "時々", isCorrect: false),
        Option(text: "完全に", isCorrect: false),
    ...
    Quiz(
      ...
      pronunciation: "ˈprɑːbəbli, プロバブリー",
      options: [
    ...
    Quiz(
      text: "of course",
      sentence: "Of course I agree.",
      translation: "もちろん私は同意する。",
      pronunciation: "əv kɔrs, オブコース",
      options: [
    ...
    Quiz(
      ...
      pronunciation: "dɪˈlɪbərɪtli, ディリバレットリー",
      options: [
        Option(text: "もちろん", isCorrect: false),
        Option(text: "すこし", isCorrect: false),
    ...
    Quiz(
      ...
      translation: "別に良くない。",
      pronunciation: "ˈsɛprətli, セパラトリー",
      options: [
        Option(text: "全部", isCorrect: false),
        Option(text: "一緒に", isCorrect: false),
        Option(text: "また", isCorrect: false),
    ...
    Quiz(
      text: "as expected",
      sentence: "As expected, he is a genius.",
      translation: "やはり彼は天才だ。",
      pronunciation: "æz ɪkˈspɛktɪd, アズ エクスペクティッド",
      options: [
    ...
    Quiz(
      text: "now",
      sentence: "Let's start now.",
      translation: "今始めよう。",
      pronunciation: "naʊ, ナウ",
      options: [
        Option(text: "多分", isCorrect: false),
        Option(text: "まだ", isCorrect: false),
    ...
    Quiz(
      text: "namely",
      sentence: "Namely, he lied.",
      translation: "即ち、彼は嘘をついた。",
      pronunciation: "ˈneɪmli, ネイムリー",
      options: [
    ...
    Quiz(
      text: "surely",
      sentence: "Surely that can't be true.",
    ...
    Quiz(
      ...
      pronunciation: "ˈmjuːʧuəli, ミューチュアリー",
      options: [
        Option(text: "即", isCorrect: false),
    ...
    Quiz(
      ...
      pronunciation: "ˈfɜːrðərˌmɔːr, ファーザーモア",
      options: [
        Option(text: "別に", isCorrect: false),
        Option(text: "もう", isCorrect: false),
        Option(text: "また", isCorrect: false),
    ...
    Quiz(
      ...
      pronunciation: "ˈsɜːrtnli, サートンリー",
      options: [
    ...
    Quiz(
      ...
      pronunciation: "kənˈsɪdərəbli, コンシデラブリー",
      options: [
    ...
    Quiz(
      text: "extremely",
      sentence: "He is extremely smart.",
      translation: "彼はとても賢い。",
      pronunciation: "ɪkˈstriːmli, エクストリームリー",
      options: [
        Option(text: "とても", isCorrect: true),
    ...
    Quiz(
      text: "a little",
      sentence: "Please wait a little.",
      translation: "少し待ってください。",
      pronunciation: "ə ˈlɪtl, ア リトル",
      options: [
        Option(text: "たくさん", isCorrect: false),
        Option(text: "とても", isCorrect: false),
        Option(text: "本当に", isCorrect: false),
    ...
    Quiz(
      text: "you all",
      sentence: "Where are you all going?",
      translation: "君たちはどこに行くの?",
      pronunciation: "ju ɔl, ユー オール",
      options: [
    ...
    Quiz(
      text: "they (females)",
      sentence: "They study together.",
      translation: "彼女たちは一緒に勉強する。",
      pronunciation: "ðeɪ (ˈfiːmeɪlz), ゼイ (フィーメイルズ)",
      options: [
